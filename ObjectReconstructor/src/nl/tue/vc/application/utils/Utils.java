...
import nl.tue.vc.application.ObjectReconstructor;
...
public final class Utils {
	...
	public static final List<String> PROJECTION_MATRICES_IDS = Arrays.asList("deg-0", "deg-30", "deg-60", "deg-90",
			"deg-120", "deg-150", "deg-180", "deg-210", "deg-240", "deg-270", "deg-300", "deg-330");
	...
	public static Image mat2Image(Mat frame) {
		try {
			...
			logger.log(Level.WARNING, "Cannot convert Mat object\n: " + e.getMessage());
			return null;
		}
	}
	...
	public static Mat bufferedImageToMat(BufferedImage bufferedImage) {
		...
		if (bufferedImage.getType() == BufferedImage.TYPE_INT_RGB) {
			...
			int[] dataBuff = bufferedImage.getRGB(0, 0, bufferedImage.getWidth(), bufferedImage.getHeight(), null, 0,
	...
	public static Mat loadImage(String imageFilename) {
		...
		try {
			...
			logger.log(Level.WARNING, "Cannot load image\n: " + e.getMessage());
		}
	...
	public static void saveImage(Mat image, String outputFilename) {
		...
		try {
			...
			logger.log(Level.WARNING, "Cannot save image\n: " + ioe.getMessage());
		}
	}
